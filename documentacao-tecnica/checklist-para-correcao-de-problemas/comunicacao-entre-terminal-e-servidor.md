...
#### **Siga os passos abaixo em ordem a fim de encontrar onde esteja o erro de comunicação entre os computadores**
...
**Compartilhamento funciona, mas ping não funciona.**\
**Path** S:\09. Ferramentas\0. Correções para problemas\Erro no compartilhamento entre computadores, mas ping funciona

**Erro de compartilhamento**\
**Path** S:\09. Ferramentas\0. Correções para problemas\Compartilhamento Windows

**Descoberta de rede e compartilhamento de impressora**\
**Path** S:\09. Ferramentas\0. Correções para problemas\Descoberta de rede e Compartilhamento de impressora
