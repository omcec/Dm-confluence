...
\#algumas-solucoes-ja-mapeadas-pela-equipe
{% endhint %}
...
<summary>Algumas soluções já mapeadas pela equipe</summary>

**Erro impressão cupom vinculado (não fiscal)**\
**Path:** S:\09. Ferramentas\0. Correções para problemas\Erro impressão cupom vinculado (não fiscal)

**Correção para problema de instalação de impressora na rede erros (0x00000709 e 0x00000040)**\
**Path:** S:\09. Ferramentas\0. Correções para problemas\Correção para problema de instalação de impressora na rede erros (0x00000709 e 0x00000040)

**0x0000011b - O Windows não pode se conectar a impressora**\
**Path:** S:\09. Ferramentas\0. Correções para problemas\0x0000011b - O Windows não pode se conectar a impressora

**Impressão na porta - Windows**\
**Path:** S:\09. Ferramentas\0. Correções para problemas\Impressão na porta - Windows

**Remoção de impressora**\
**Path:** S:\09. Ferramentas\0. Correções para problemas\Remoção de impressora
