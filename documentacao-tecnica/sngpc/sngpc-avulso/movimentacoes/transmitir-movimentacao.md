...
2. Ir até o menu Relatórios > Status de transmissão **\*consultar passo a passo em** [**Consulta status de transmissão**](https://dmaster.gitbook.io/base-de-conhecimento-dmaster/documentacao-interna/documentacao-tecnica/sngpc/site-anvisa#consulta-status-de-transmissao)
